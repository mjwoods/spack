...
class Metview(CMakePackage):
    ...
    depends_on('magics+netcdf+metview+qt grib=grib-api', when='+magics+gui~eccodes')
    depends_on('magics+netcdf+metview~qt grib=grib-api', when='+magics~gui~eccodes')
    depends_on('magics+netcdf+metview+qt grib=eccodes', when='+magics+gui+eccodes')
    depends_on('magics+netcdf+metview~qt grib=eccodes', when='+magics~gui+eccodes')
    depends_on('libemos grib=grib-api', when='~eccodes')
    depends_on('libemos grib=eccodes', when='+eccodes')
